 ...
 * Recorded events and properties are URL encoded before being saved to a send
 * queue.
 */
public class ArchiverImpl implements Archiver {
    ...
    /**
     * Initializes and/or returns the ArchiverImpl singleton instance. This
     ...
     *
     * @param doSend Setting to control the uploading of aliases, events and
     * properties.
     */
    @Override
     ...
     *
     * @param doTrack Setting to control recording of aliases, events and
     * properties.
     */
    @Override
     ...
     * Used when establishing a new identity that is not aliased to any other
     * identity.
     * Nothing is passed to KISSmetrics as a result of archiving a first
     * identity.
     *
     ...
     *
     * @param hasGenericIdentity setting to indicate that a proper identity has
     * been given.
     */
    @Override
     ...
     *
     * @param installUuid Unique identifier of the application install which
     * may
     * only be
     * archived once.
     */
    ...
    /**
     * Archives doTrack verification expiration date to Settings > Internal
     * Storage.
     *
     ...
     * Intended to be used to remove successful API queries or malformed
     * queries
     * to prevent
     * repeated attempts to query the KISSmetrics API with URL strings that
     * will
     * never succeed.
     *
     * @param index Query string index in the sendQueue
    ...
    /**
     * Unarchives saved events from Internal Storage or establishes a new List
     * object.
     * Sets value of mSavedIdEvents with unarchived saved events.
     * <p/>
     * Suppresses warnings for ObjectInputStream readObject cast to
     * List<String>.
     */
    ...
    /**
     * Unarchives saved install events from Internal Storage or establishes a
     * new List object.
    ...
    /**
     * Unarchives saved properties from Internal Storage or establishes new a
     * HashMap object.
    ...
    /**
     * Unarchives sendQueue from Internal Storage or establishes a new
