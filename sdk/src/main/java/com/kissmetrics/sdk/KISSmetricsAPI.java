...
public final class KISSmetricsAPI implements VerificationDelegate {
    ...
    /**
     * Initializes and/or returns the KISSmetricsAPI singleton instance.
     *
     * @param apiKey KISSmetrics product key
     * @param context Android application context
     * @param secure !Ignored!
     *
     * @return singleton instance of the {@link KISSmetricsAPI}
     *
    ...
    /**
     * Records an event per identity or install depending on the
     * RecordCondition
     * that's passed.
     *
     * @param name Event name
     * @param properties Event properties or null
     * @param condition RecordCondition (RecordOncePerInstall,
     * RecordOncePerIdentity).
     * <p/>
     * <ul>
     * <li>Using RecordOncePerInstall: The event will only be recorded once
     * during the lifetime of the application's installation. If the event
     * has already been recorded, any properties passed will also be
     * ignored.</li>
     * <li>Using RecordOncePerIdentity: The event will only be recorded once
    ...
    /**
     * Convenience method for recording an event on a RecordCondition without
     * properties.
     *
     * @param name Event name
     * @param condition RecordCondition (RecordOncePerInstall,
    ...
    /**
     * Sets a single property if the value is different from the last set
     * value.
     *
     * @param propertyName
     * @param value
