...
public interface TrackingRunnables {
    /**
     * Creates a Runnable to archive and send an alias for the current tracking
     * state.
     *
     * @param alias User alias String.
     * @param identity User identity String.
     * @param archiver The instance of Archiver to use.
     * @param kmapi The instance of KISSmetricsAPI where initiation of recursive
     * send should
     * occur.
     *
     * @return A Runnable object that will run appropriate tasks for the current
     * tracking state.
     */
    ...
    /**
     * Creates a Runnable to archive an unassociated user identity for the
    ...
    /**
     * Creates a Runnable to archive and send an identity for the current
     * tracking state.
     *
     * @param identity User identity String.
     * @param archiver The instance of Archiver to use.
    ...
    /**
     * Creates a Runnable to archive and send 1 or more user properties for the
     * current tracking
     * state.
     *
    ...
    /**
     * Creates a Runnable to archive and send properties with a new or different
     * value for the
