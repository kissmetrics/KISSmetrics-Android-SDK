...
public class TrackingRunnablesNonTrackingState implements TrackingRunnables {
    ...
    /**
     * Ignores calls to archive an unassociated user identity while in a
     * non-tracking state.
     *
     * @param identity User identity String.
     * @param archiver The instance of Archiver to use.
    ...
    /**
     * Ignores calls to archive and send an event once while in a non-tracking
     * state.
     *
     * @param name Event name.
     * @param archiver The instance of Archiver to use.
    ...
    /**
     * Creates a Runnable to archive and send properties while in a non-tracking
     * state.
     *
    ...
    /**
     * Creates a Runnable to archive and send distinct properties while in a
     * non-tracking state.
     *
