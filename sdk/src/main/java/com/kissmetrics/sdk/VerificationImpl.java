...
class VerificationImpl {
    ...
    /**
     * Makes a request to the provided verification url string.
     * Handles the response and notifies the provided {@link
     * VerificationDelegate} on
     * completion.
     *
     ...
     * Allows for injection of mock {@link HttpURLConnection} via method override.
     *
